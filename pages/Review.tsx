                ...
                <div className="flex items-start justify-between">
                  ...
                  <div className="flex items-center gap-2 flex-shrink-0 ml-3">
                    <button
                      onClick={(e) => {
                        e.stopPropagation();
                        updateReviewStats(word.id, { retryCount: 0, skipped: false });
                      }}
                      className="px-2 py-1 text-tiny text-green-600 bg-green-50 border border-green-200 rounded hover:bg-green-100 transition-colors"
                    >
                      已复习
                    </button>
